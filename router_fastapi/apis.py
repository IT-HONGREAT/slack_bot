...
from router_fastapi.models import Alarm, ContractManagement
...
@router.post("/contract_management_alarm")
async def contract_management_alarm(contract: ContractManagement):

    user_id = get_user_information(bolt_app.client.users_list(), client_user_email=contract.user_email)
